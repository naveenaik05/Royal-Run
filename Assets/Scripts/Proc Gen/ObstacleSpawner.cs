...
public class ObstacleSpawner : MonoBehaviour
{
    ...
    IEnumerator SpawnObstacleRoutine()
    {
        while(true)
        {
            ...
            Vector3 spawnPostion =  new Vector3(Random.Range(-spawnWidth,spawnWidth),transform.position.y,transform.position.z);
            yield return new WaitForSeconds(obstacleSpawnTime);
            Instantiate(obstaclePrefab,spawnPostion,Random.rotation,obstacleParent);
        }
    }
}
