...
public class Chunk : MonoBehaviour
{
    ...
    public void Init(LevelGenarator levelGenarator,ScoreManager scoreManager)
    {
    ...
    void SpawnFences()
    {
        ...
        int faceToSpawn = Random.Range(0,lanes.Length);

        for (int i = 0; i < faceToSpawn; i++)
        {
